...
import 'models/CommonResponseData.dart';
...
class _ChangePasswordScreenState extends State<ChangePasswordScreen> {
  ...
  String strMobileError="Enter password";
...
//  }
  ...
  void login(){
    ...
    if(mobileNumber.length>0&&password.length>0){
      if(mobileNumber==password){
        ...
        isMobile=false;
        strMobileError="Password mismatch";
        setState(() {});
      }
  ...
  void loginRequest(String email,String password) async{
    ...
    try {
      ...
      showProgress();
      Response? response = await callAPIServiceWithHeader(APIUtils.API_CHANGE_PWD, data,headerData,context);
      hideProgress();
      if (response!=null&&response.statusCode == 200) {
        CommonResponseData responseData=CommonResponseData.fromJson(response.data);

        if(responseData.success!){
          CommonUtils.showSuccessToast(context, "Password changed successfully.");
          goBack();
        }else{
  ...
  Widget build(BuildContext context) {
    ...
    final passwordField = TextField(
      ...
      decoration: InputDecoration(
          ...
          errorText: isPassword?null:"Enter confirm password",
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Text("Change Password",textAlign: TextAlign.center,style: styleLarge.copyWith(color: ColorUtils.black)),
                                        SizedBox(height: DimensionUtils.margin_xxxlarge),
                                        emailField,
